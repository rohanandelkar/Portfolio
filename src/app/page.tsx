    ...
    <main className="signal-page">
      ...
      <header className="signal-nav">
        ...
        <nav className={menuOpen ? "signal-links open" : "signal-links"}>
          <a href="#work" onClick={() => setMenuOpen(false)}>Work</a><a href="#story" onClick={() => setMenuOpen(false)}>Story</a><a href="#stack" onClick={() => setMenuOpen(false)}>Stack</a><a href="#contact" onClick={() => setMenuOpen(false)}>Contact</a>
        </nav>
      ...
      <section className="signal-hero shell" id="top">
        ...
        <div className="orbital-art">
          ...
          <div className="orbital-core"><BrainCircuit size={46} /><span>BUILD<br />SIGNAL<br />LOOP</span></div>
      ...
      <section className="shell work-section" id="work">
        ...
        <div className="bento-grid">
          {projects.map((project) => <article className={`bento-card ${project.tone} ${project.size}`} key={project.id}>
            ...
            <div className="card-visual"><div className="visual-lines" /><span className="visual-code">{project.id === "01" ? "object.detect()" : project.id === "02" ? "traffic / anomaly" : project.id === "03" ? "model.fit(data)" : "insight → action"}</span></div>
